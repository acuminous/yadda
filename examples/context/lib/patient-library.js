...
module.exports = (function() {
    ...
    var library = new Yadda.Library()
        ...
        .define('$patientName is a patient at $hospitalName hospital.',
            function(patientName, hospitalName, next) {
                this.ctx.patient = {
                    name: patientName,
        ...
        .define('His chart should reflect all of the above', function(next) {
            ...
            assert.deepEqual(chart.discharge.requirements.toString(),
                             patient.discharge.requirements.toString());
            next();
        });
