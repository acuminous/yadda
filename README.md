...
## Installation
Yadda 0.7.0 is the current verison, and includes a breaking change from previous versions - The TextParser has been renamed to FeatureParser, and a simpler StepParser added, which assumes no syntax has been added.
...
```html
<script src="./lib/yadda-0.7.0.js"></script>
```
## Writing Yadda Tests
