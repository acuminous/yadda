...
## Latest Version
Yadda 0.9.8 is the current verison, which includes support for component. See the examples for details - thanks [johntron](https://github.com/johntron).
...
```html
<script src="./lib/yadda-0.9.8.js"></script>
```
## Writing Yadda Tests
