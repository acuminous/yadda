...
- **Markdown feature files.** Write specifications as GitHub-flavoured markdown so they render beautifully on GitHub, with headings for features and scenarios, list items for steps, fenced blocks for doc-strings, and markdown tables for data. See [Markdown Feature Files](docs/feature-files.md#markdown-feature-files).
