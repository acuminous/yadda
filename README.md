...
## Installation
Yadda 0.4.6 is the current verison. It includes an improvement to the TextParser to support feature blocks. (thanks [mrwiggles](https://github.com/mrwiggles)).
...
```html
<script src="./lib/yadda-0.4.6.js"></script>
```
## Writing Yadda Tests
