...
## Installation
Yadda 0.6.2 is the current verison. It includes enhanced support for annoations. See the release notes and examples for more deatils.
...
```html
<script src="./lib/yadda-0.6.2.js"></script>
```
## Writing Yadda Tests
