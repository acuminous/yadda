...
## Latest Version
Yadda 0.9.5 is the current verison, which includes French localisation kindly contributed by [ami44](https://github.com/ami44), revamped examples, better debug around undefined and ambiguous steps see [issue 30](https://github.com/acuminous/yadda/issues/30) and (long awaited) support for Example Tables - see [issue 15](github.com/acuminous/yadda/issues/15). This was quite a large change, involving a complete re-write of the FeatureParser. The file format **should** be backwards compatible, but please raise an issue if your feature files suddenly stop working after the upgrade from 0.8.x.
...
```html
<script src="./lib/yadda-0.9.5.js"></script>
```
## Writing Yadda Tests
