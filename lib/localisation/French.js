...
module.exports = (function() {
    ...
    var vocabulary = {
        ...
        scenario: '(?:[Ss]cénario)',
        pending: 'En attente',
        given: '(?:[ÉéEe]tant données|[ÉéEe]tant donnée|[ÉéEe]tant donnés|[ÉéEe]tant donné|Soit|[Aa]vec|[Ee]t|[Mm]ais|[Aa]ttendre)',
        when: '(?:[Ll]orsqu\'<|[Ll]orsque|[Qq]uand|[Ss]i|[Ee]t|[Mm]ais)',
        then: '(?:[Aa]lors|[Aa]ttendre|[Ee]t|[Mm]ais)',
        
        _steps: ['given', 'when', 'then', 'soit', 'quand', 'alors'],
