...
var TextParser = function() {
    ...
    var split = function(text) {
		var non_blank = $(text.split(/\n/)).find_all(non_blanks);
		return non_blank.find_all(non_annotations);
		//.find_all(non_annotations);
    };

	var non_annotations = function(text) {
		return text && ANNOTATION_REGEX.test(text);
	};	
